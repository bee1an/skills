...
```bash
npx skills add bee1an/skills
```

Install specific skills:

```bash
npx skills add bee1an/skills --skill vue vite transitions-dev
```
...
| slidev | [antfu/skills](https://github.com/antfu/skills) |
...
| vue-best-practices | [antfu/skills](https://github.com/antfu/skills) |
| vue-router-best-practices | [antfu/skills](https://github.com/antfu/skills) |
| vue-testing-best-practices | [antfu/skills](https://github.com/antfu/skills) |
